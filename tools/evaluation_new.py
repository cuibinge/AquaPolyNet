...
# boundary_iou 新版本已无 coco_instance_api，仅边界 IoU 需要时再用
BCOCO = None
BCOCOeval = None
...
def boundary_eval(annFile, resFile):
    ...
    if BCOCO is None:
    	logger.warning("boundary-iou 新版无 coco_instance_api，跳过 boundary_eval")
    	return
...
def evaluate_all(annFile, resFile):
    ...
    pixel_boundary_eval(annFile, resFile)
