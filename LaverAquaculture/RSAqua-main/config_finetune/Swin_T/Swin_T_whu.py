...
load_from = 'shared-nvme/RSBuilding-main/pretrain/Swin_T/iter_28000.pth' # !!!! must change this !!!!
resume_from = None
...
names = 'Swin_T_whu'
# work_dir = '/root/shared-nvme/RSBuilding-main/pretrain/Swin_T/vis/'
work_dir = 'D:/python/RSBuilding-main/pretrain/Swin_T/vis/'
...
""" ************************** schedule **************************"""
custom_imports = dict(
    imports=['opencd.visualization.cd_local_visualizer'],
