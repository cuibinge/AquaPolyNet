...
# data_list path
# train_data_list = 'data_dir/whubuilding/train.txt'
# test_data_list = 'data_dir/whubuilding/test.txt'
...
backbone_checkpoint = 'pretrain/Swin_T.pth'
...
names = 'Swin_T'
# work_dir = '/RSBuilding-main/pretrain/model/' + names
# work_dir = '/root/shared-nvme/RSBuilding-main/pretrain/Swin_T_lyg_loss6_adaptive'
work_dir = '/root/shared-nvme/RSBuilding-main/pretrain/Swin_T'
